## Pj010_Simulating_TwoBody_SDE_save_data.py
# Based on Pj008_Simulating_TwoBody_SDE.py
# ------------------------- #
# Description:
...
# Edits: 29 July 2016: simulation time step divided by 10 to 0.0001[s]. Simulation period reduced from 2[h] to 5[min].
# ------------------------- #
...
dt = 0.0001;#[s]
simul = 60*2; # simulate for 2 minutes
timevec = np.arange(t,simul,dt,dtype=np.float64) # simulation period
true_Qc = np.diag([2.4064e-4,2.4064e-4,2.4064e-4])  ; # can be tuned as desired.
...
fname = 'Pj010_Simulating_TwoBody_SDE_save_data.txt';
