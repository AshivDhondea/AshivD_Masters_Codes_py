...
dt = 0.001;#[s]
t_end = 300;#[s] 
Tk = 8;#decimation in time.i.e. measurements are sampled at a rate 10 times smaller than x.
...
true_m0 = np.array([2085.28502298,-3686.32741629,5293.29270671,6.28531303846,4.35805977273,0.554788817437 ],dtype=np.float64);
...
index = 0;
with open('Pj016_CDEKFpaper_Code002_x.txt') as fp:
    for line in fp:
        data = line.split();
        # Place the data read in from the file into the array of state vectors.
